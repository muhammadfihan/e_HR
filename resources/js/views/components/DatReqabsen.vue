        ...
        <table class="table align-items-center mb-0">
          ...
          <tbody>
            <tr v-for="(data,index) in reqabsen.data" :key="data.id">
              ...
              <td class="align-middle text-center text-sm" >
                <span v-if="data.status_req == 'Diproses'">
                  <span style="margin-right:7px;cursor:pointer" class="badge badge-sm bg-warning" @click.prevent="approvereqabsen(data.id)">approvement</span>
                </span>
                <span v-else-if="data.status_req !== 'Diproses'">
