    ...
    <div class="card-header pb-0">
      <div class="row">
        <div class="col-6 d-flex align-items-center">
          <h6 class="mb-0">Tabel Akun Pegawai</h6>
        </div>
        <div class="col-6 text-end">
          <argon-button v-if="cuti.length != 0" color="success" size="sm" variant="gradient" @click="showModal()">
            <i class="fas fa-plus me-2" ></i>Tambah Akun Pegawai</argon-button>
