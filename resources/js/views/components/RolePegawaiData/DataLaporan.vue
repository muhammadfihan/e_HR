          ...
          <tbody>
            <tr v-for="(data,index) in laporan.data" :key="data.id">
              ...
              <td class="align-middle text-center text-md">
                ...
                <span v-if="data.status_laporan == 'Diproses'" @click.prevent="showModalEdit(data)" style="cursor:pointer; margin-right: 7px;" class="badge badge-sm bg-gradient-success disabled"><i class="fas fa-edit"></i></span>
                <span v-if="data.status_laporan == 'Diproses'" @click.prevent="hapuslaporan(data.id)" style="cursor:pointer" class="badge badge-sm bg-danger"><i class="far fa-trash-alt"></i></span>
              </td>
            </tr>
          </tbody>
        </table>
