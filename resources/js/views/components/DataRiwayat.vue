        ...
        <table class="table align-items-center mb-0">
          ...
          <tbody >
            <tr v-for="data in riwayatgaji.data" :key="data.id">
              <td ></td>
              <td v-if="data.status == 'Sudah Diambil'" class="align-middle">
              ...
              <td  class="align-middle">
                <span class="text-secondary text-xs font-weight-bold" v-if="data.status == 'Sudah Diambil'">
                    <a>{{convertToRupiah(data.gaji_bersih)}}</a>
                </span>
              </td>
              <td  class="align-middle text-center text-sm">
                <span class="badge badge-sm bg-success" v-if="data.status == 'Sudah Diambil'">Sudah Diambil</span>
              </td>
              <td  class="align-middle text-sm text-center">
                  <span  @click.prevent="getriwayatdetail(data.id)" style="margin-right:7px;cursor:pointer" class="badge badge-sm bg-primary" data-toggle="modal" >Detail</span>
              </td>
            </tr>
          </tbody>
        </table>
