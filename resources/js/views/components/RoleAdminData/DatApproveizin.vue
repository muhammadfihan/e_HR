        ...
        <table class="table align-items-center mb-0">
          ...
          <tbody>
            <tr v-for="(data,index) in izin.data" :key="data.id">
              ...
              <td class="align-middle text-center text-sm ">
                <span class="badge badge-sm bg-info" v-if="data.status_izin == 'Diproses'">Belum Disetujui</span>
              ...
              <td class="align-middle text-center text-sm" >
                <span @click.prevent="approveizin(data.id)" style="cursor:pointer;margin-right:7px;" class="badge badge-sm bg-primary">Manage</span>
              </td>
            </tr>
          </tbody>
        </table>
