<template>
  <div class="card h-1000" style="height:630px !important">
    <div class="card-header pb-0">
      <div class="row">
        ...
        <div class="col-6 text-end">
          <argon-button color="primary" @click="showModal2()" size="sm" variant="gradient">Tambah Bonus</argon-button>
        </div>
    ...
    <div class="card-body px-0 pt-0 pb-2 mb-3">
      <div class="table-responsive p-0" v-if="this.bonus == ''">
      ...
      <div class="table-responsive p-0 border-bottom" v-else-if="this.bonus != ''">
        <table class="table align-items-center mb-0">
          <thead>
            <tr>
              <th
          ...
          <!-- <tbody v-if="this.bonus == ''">
            <tr  class="text-center ms-10" style="height:339px !important">
              td Kosong
            </tr>
          </tbody> -->
          <tbody>
            <tr v-for="(data,index) in bonus" :key="data.id">
              ...
              <td class="text-center text-sm align-middle" >
                  <span @click.prevent="showModalEdit2(data)" style="cursor:pointer; margin-right: 7px;" class="badge badge-sm bg-warning disabled"><i class="fas fa-edit"></i></span>
                  <span @click.prevent="hapusbonus(data.id)" style="cursor:pointer" class="badge badge-sm bg-danger"><i class="far fa-trash-alt"></i></span>
              </td>
            </tr>
          </tbody>
        </table>
