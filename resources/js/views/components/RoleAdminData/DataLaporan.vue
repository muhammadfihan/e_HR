      ...
      <div class="row">
        ...
        <div class="col-md-4 mt-2 mb-3">
          <div class="d-flex form-input input-group">
            ...
            <input v-model="search" style="border:none; box-shadow: none;" class="form-control form-control-md bg-gray-100" type="text" placeholder="Cari Berdasarkan Nama/Email..." >
          </div>
        </div>
      </div>
    </div>
