<template>
  <div class="card h-1000" style="height:630px !important">
    ...
    <div class="card-body px-0 pt-0 pb-2 mb-3">
      <div v-if="this.tunjangan == ''" class="table-responsive p-0">
      ...
      <div v-else-if="this.tunjangan != ''" class="table-responsive p-0 border-bottom">
        <table class="table align-items-center mb-0">
          <thead>
            <tr>
              <th
          ...
          <tbody>
            <tr v-for="(data, index) in tunjangan" :key="data.id">
              ...
              <td class="text-center text-sm align-middle" >
                  ...
                  <span @click.prevent="hapustunjangan(data.id)" style="cursor:pointer" class="badge badge-sm bg-danger"><i class="far fa-trash-alt"></i></span>
              </td>
            </tr>
          </tbody>
        </table>
