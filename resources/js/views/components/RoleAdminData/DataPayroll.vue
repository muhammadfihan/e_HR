    ...
    <div class="card-header pb-0">
      <div class="row">
        ...
        <div class="col-6 text-end">
          <argon-button  color="primary" @click="buatgaji()" size="sm" variant="gradient">Buat Gaji</argon-button>
        </div>
      ...
      <div class="modal-body">
                <form>
                    <div class="mb-3">
                        ...
                        <select class="form-select" v-model="form.email" @click="emailselect" @change="emailselect">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-control">
                            <i v-if="form.pokok == null" style="visibility:hidden">ABCD</i>
                            <span v-for="jab in detjabatan" :key="jab.id"><a v-if="form.pokok == jab.id">{{jab.jabatan}} : {{convertToRupiah(jab.gaji)}}</a></span>
                        </div>
                    </div>
                    <hr style="border-top: 1.5px solid #bbb;">
    ...
    methods:{
        emailselect(){
            if(this.form.email == null){
                ...
                console.log(this.form.email.toString().split(","))
                this.form.pokok = this.jabat[this.emailpeg.toString().split(",").indexOf(this.form.email.toString())]
            }
        },
        select() {
        ...
        getdataPegawai(){
            ...
            this.$axios.get('/api/sudahisi',{
                ...
                .then(response => {
                    ...
                    this.emailpeg = response.data.email
                })
