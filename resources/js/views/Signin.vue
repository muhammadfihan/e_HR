        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5">
              <div class="text-muted text-center mb-4">Anda Akan Login Sebagai Admin</div>
              ...
              <form role="form">
                ...
                <div class="custom-control custom-control-alternative text-end">
                  <label class="label"><span style="cursor:pointer" class="text-primary" @click="tolupaadmin()">Forget Password ?</span></label>
                </div>
              </div>
              <div class="text-center">
                <div class="my-4">
