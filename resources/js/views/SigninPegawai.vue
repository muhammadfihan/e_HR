          ...
          <div class="card" style="background-color: #F5F5FC;box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px;">
            <div class="card-header bg-transparent pb-4">
              ...
              <div class="text-center">
                <a href="#" class="btn btn-neutral btn-icon mr-4" @click="toadmin()">
            ...
            <div class="card-body px-lg-5">
              ...
              <form role="form">
                ...
                <div class="custom-control custom-control-alternative text-end">
                  <label class="label"><span style="cursor:pointer" class="text-primary" @click="tolupapasword()">Forget Password ?</span></label>
                </div>
              </div>
              <div class="text-center">
                <div class="my-4">
                  <argon-button color="primary" @click="loginpegawai" size="md" fullWidth variant="gradient">Login Pegawai</argon-button>
                </div>
              </div>
              </form>
            </div>
