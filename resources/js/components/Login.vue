        ...
        <div class="forms-navbara">
            <div class="signin-signup">
                ...
                <form class="sign-in-form">
                    ...
                    <input type="submit" value="Masuk" @click="login" class="tmbl"  />
                </form>
        ...
        <div class="panels-navbara">
            <div class="panel left-panel">
                <div class="content">
                    ...
                    <button class="tmbl transparent" id="sign-up-btn">
                        Daftar
                    </button>
                </div>
            ...
            <div class="panel right-panel">
                <div class="content">
                    ...
                    <button class="tmbl transparent" id="sign-in-btn">
                        Masuk
                    </button>
                </div>
                <img :src="'/images/registernew.svg'" class="image" alt="" />
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    mounted() {
        ...
        sign_up_btn.addEventListener("click", () => {
            navbara.classList.add("sign-up-mode");
        });

        sign_in_btn.addEventListener("click", () => {
            navbara.classList.remove("sign-up-mode");
        });
    },
    data() {
        return {
