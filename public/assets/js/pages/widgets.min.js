...
var KTWidgets = function() {
    var t = function(t) {
        ...
        e && KTUtil.on(e, "thead th .checkbox > input", "change", (function(t) { for (var o = KTUtil.findAll(e, "tbody td .checkbox > input"), s = 0, a = o.length; s < a; s++) o[s].checked = this.checked }))
    };
    return {
        init: function() {
            var e, o, s, a;
            ! function() {
                if (0 != $("#kt_dashboard_daterangepicker").length) {
                    var t = $("#kt_dashboard_daterangepicker"),
                        e = moment(),
                        o = moment();
                    t.daterangepicker({ direction: KTUtil.isRTL(), startDate: e, endDate: o, opens: "left", applyClass: "btn-primary", cancelClass: "btn-light-primary", ranges: { Today: [moment(), moment()], Yesterday: [moment().subtract(1, "days"), moment().subtract(1, "days")], "Last 7 Days": [moment().subtract(6, "days"), moment()], "Last 30 Days": [moment().subtract(29, "days"), moment()], "This Month": [moment().startOf("month"), moment().endOf("month")], "Last Month": [moment().subtract(1, "month").startOf("month"), moment().subtract(1, "month").endOf("month")] } }, s), s(e, o, "")
                }
            ...
            function() {
                var t = document.getElementById("kt_mixed_widget_14_chart"),
                    e = parseInt(KTUtil.css(t, "height"));
                if (t) {
                    var o = { series: [74], chart: { height: e, type: "radialBar" }, plotOptions: { radialBar: { hollow: { margin: 0, size: "65%" }, dataLabels: { showOn: "always", name: { show: !1, fontWeight: "700" }, value: { color: KTApp.getSettings().colors.gray["gray-700"], fontSize: "30px", fontWeight: "700", offsetY: 12, show: !0, formatter: function(t) { return t + "%" } } }, track: { background: KTApp.getSettings().colors.theme.light.success, strokeWidth: "100%" } } }, colors: [KTApp.getSettings().colors.theme.base.success], stroke: { lineCap: "round" }, labels: ["Progress"] };
                    new ApexCharts(t, o).render()
                }
            }(),
            function() {
            ...
            function() {
                var t = document.getElementById("kt_tiles_widget_21_chart"),
                    ...
                    o = KTUtil.hasAttr(t, "data-color") ? KTUtil.attr(t, "data-color") : "info";
                if (t) {
                    var s = { series: [{ name: "Net Profit", data: [20, 20, 30, 15, 30, 30] }], chart: { type: "area", height: e, toolbar: { show: !1 }, zoom: { enabled: !1 }, sparkline: { enabled: !0 } }, plotOptions: {}, legend: { show: !1 }, dataLabels: { enabled: !1 }, fill: { type: "solid", opacity: 1 }, stroke: { curve: "smooth", show: !0, width: 3, colors: [KTApp.getSettings().colors.theme.base[o]] }, xaxis: { categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1, style: { colors: KTApp.getSettings().colors.gray["gray-500"], fontSize: "12px", fontFamily: KTApp.getSettings()["font-family"] } }, crosshairs: { show: !1, position: "front", stroke: { color: KTApp.getSettings().colors.gray["gray-300"], width: 1, dashArray: 3 } }, tooltip: { enabled: !0, formatter: void 0, offsetY: 0, style: { fontSize: "12px", fontFamily: KTApp.getSettings()["font-family"] } } }, yaxis: { min: 0, max: 32, labels: { show: !1, style: { colors: KTApp.getSettings().colors.gray["gray-500"], fontSize: "12px", fontFamily: KTApp.getSettings()["font-family"] } } }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px", fontFamily: KTApp.getSettings()["font-family"] }, y: { formatter: function(t) { return "$" + t + " thousands" } } }, colors: [KTApp.getSettings().colors.theme.light[o]], markers: { colors: [KTApp.getSettings().colors.theme.light[o]], strokeColor: [KTApp.getSettings().colors.theme.base[o]], strokeWidth: 3 } };
                    new ApexCharts(t, s).render()
                }
            }(),
            function() {
                ...
                if (t) {
                    var o = { series: [{ name: "Net Profit", data: [15, 25, 15, 40, 20, 50] }], chart: { type: "area", height: 125, toolbar: { show: !1 }, zoom: { enabled: !1 }, sparkline: { enabled: !0 } }, plotOptions: {}, legend: { show: !1 }, dataLabels: { enabled: !1 }, fill: { type: "solid", opacity: 1 }, stroke: { curve: "smooth", show: !0, width: 3, colors: [KTApp.getSettings().colors.theme.base[e]] }, xaxis: { categories: ["Jan, 2020", "Feb, 2020", "Mar, 2020", "Apr, 2020", "May, 2020", "Jun, 2020"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1, style: { colors: KTApp.getSettings().colors.gray["gray-500"], fontSize: "12px", fontFamily: KTApp.getSettings()["font-family"] } }, crosshairs: { show: !1, position: "front", stroke: { color: KTApp.getSettings().colors.gray["gray-300"], width: 1, dashArray: 3 } }, tooltip: { enabled: !0, formatter: void 0, offsetY: 0, style: { fontSize: "12px", fontFamily: KTApp.getSettings()["font-family"] } } }, yaxis: { min: 0, max: 55, labels: { show: !1, style: { colors: KTApp.getSettings().colors.gray["gray-500"], fontSize: "12px", fontFamily: KTApp.getSettings()["font-family"] } } }, states: { normal: { filter: { type: "none", value: 0 } }, hover: { filter: { type: "none", value: 0 } }, active: { allowMultipleDataPointsSelection: !1, filter: { type: "none", value: 0 } } }, tooltip: { style: { fontSize: "12px", fontFamily: KTApp.getSettings()["font-family"] }, y: { formatter: function(t) { return "$" + t + " thousands" } } }, colors: [KTApp.getSettings().colors.theme.light[e]], markers: { colors: [KTApp.getSettings().colors.theme.light[e]], strokeColor: [KTApp.getSettings().colors.theme.base[e]], strokeWidth: 3 } };
                    new ApexCharts(t, o).render()
                }
            }(), t("kt_advance_table_widget_1"), t("kt_advance_table_widget_2"), t("kt_advance_table_widget_3"), t("kt_advance_table_widget_4"), e = "kt_price_slider", void 0 !== (o = document.getElementById(e)) && o && noUiSlider.create(o, { start: [20, 60], connect: !0, range: { min: 0, max: 100 } }), (s = KTUtil.getById("kt_forms_widget_1_input")) && autosize(s), KTUtil.getById("kt_forms_widget_2_form") && new Quill("#kt_forms_widget_2_editor", { modules: { toolbar: { container: "#kt_forms_widget_2_editor_toolbar" } }, placeholder: "Type message...", theme: "snow" }),
                function() {
...
"undefined" != typeof module && (module.exports = KTWidgets), jQuery(document).ready((function() { KTWidgets.init() }));