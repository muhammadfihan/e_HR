...
--
-- Host: localhost
-- Generation Time: Sep 07, 2022 at 06:22 AM
...
INSERT INTO `bonus` (`id`, `email_admin`, `jenis_bonus`, `nominal`, `created_at`, `updated_at`) VALUES
(1, 'admin@gmail.com', 'Tidak Ada Bonus', 0, '2022-09-06 21:21:41', '2022-09-06 21:21:41');
...
INSERT INTO `potongan` (`id`, `email_admin`, `jenis_potongan`, `nominal`, `created_at`, `updated_at`) VALUES
(1, 'admin@gmail.com', 'Tidak Ada Potongan', 0, '2022-09-06 21:21:41', '2022-09-06 21:21:41');
...
INSERT INTO `tunjangan` (`id`, `email_admin`, `jenis_tunjangan`, `nominal`, `created_at`, `updated_at`) VALUES
(1, 'admin@gmail.com', 'Tidak Ada Tunjangan', 0, '2022-09-06 21:21:41', '2022-09-06 21:21:41');
...
(1, 'Admin', 'admin@gmail.com', 'Admin', 'CEO', 'PT AMS Indonesia', 'Jawa Tengah', 'Surakarta', 'Sekolah Vokasi Universitas Sebelas Maret, Surakarta, Jawa Tengah', 123456789, 12345, 'IT', 50, NULL, '$2y$10$NFbVvjgFwTfDqjCGdmPk.uwFcVyaKlmQSdbfWSnAo8P7SXzOJhcia', NULL, NULL, NULL, NULL);
...
ALTER TABLE `laporan`
  ...
  ADD CONSTRAINT `laporan_id_jabatan_foreign` FOREIGN KEY (`id_jabatan`) REFERENCES `akunpegawai` (`id_jabatan`);
